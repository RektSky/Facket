...
**Caller -> Returner** Send a method call request
```
methodCallRequest {
   PacketType type = PacketType.SEND;     // Send request
   s4 packetId;                           // Random int generated by the caller
...
```
Returner should be implemented to call the requested method, get the return value and 
